 ...
 * If the shop servlet is provided with parameters that indicates an amount of 
 * a given cupcake. This information can (in assignment 5) be forwarded to 
 * another servlet that will store it in the shopping cart.
 * 
 * 
 * 
 * 
