 ...
 * servlet (when a user selects a cupcake from the list) and create a LineItem
 * with the cupcake and the desired number and add it to the ShoppingCart object
 * (in the session)
 */
